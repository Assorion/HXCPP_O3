...
HX_DEFINE_STACK_FRAME(_hx_pos_952f47cc2225e9ea_55_new,"haxe.crypto.Md5","new",0x90507feb,"haxe.crypto.Md5.new","/usr/share/haxe/std/haxe/crypto/Md5.hx",55,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_57_bitOR,"haxe.crypto.Md5","bitOR",0xbf34737b,"haxe.crypto.Md5.bitOR","/usr/share/haxe/std/haxe/crypto/Md5.hx",57,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_63_bitXOR,"haxe.crypto.Md5","bitXOR",0x8eb76a23,"haxe.crypto.Md5.bitXOR","/usr/share/haxe/std/haxe/crypto/Md5.hx",63,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_69_bitAND,"haxe.crypto.Md5","bitAND",0x8ea5f55f,"haxe.crypto.Md5.bitAND","/usr/share/haxe/std/haxe/crypto/Md5.hx",69,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_75_addme,"haxe.crypto.Md5","addme",0x2873c404,"haxe.crypto.Md5.addme","/usr/share/haxe/std/haxe/crypto/Md5.hx",75,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_81_hex,"haxe.crypto.Md5","hex",0x904bf266,"haxe.crypto.Md5.hex","/usr/share/haxe/std/haxe/crypto/Md5.hx",81,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_155_rol,"haxe.crypto.Md5","rol",0x9053919a,"haxe.crypto.Md5.rol","/usr/share/haxe/std/haxe/crypto/Md5.hx",155,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_159_cmn,"haxe.crypto.Md5","cmn",0x90482e0f,"haxe.crypto.Md5.cmn","/usr/share/haxe/std/haxe/crypto/Md5.hx",159,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_163_ff,"haxe.crypto.Md5","ff",0xde352415,"haxe.crypto.Md5.ff","/usr/share/haxe/std/haxe/crypto/Md5.hx",163,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_167_gg,"haxe.crypto.Md5","gg",0xde3524f5,"haxe.crypto.Md5.gg","/usr/share/haxe/std/haxe/crypto/Md5.hx",167,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_171_hh,"haxe.crypto.Md5","hh",0xde3525d5,"haxe.crypto.Md5.hh","/usr/share/haxe/std/haxe/crypto/Md5.hx",171,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_175_ii,"haxe.crypto.Md5","ii",0xde3526b5,"haxe.crypto.Md5.ii","/usr/share/haxe/std/haxe/crypto/Md5.hx",175,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_178_doEncode,"haxe.crypto.Md5","doEncode",0x943f9096,"haxe.crypto.Md5.doEncode","/usr/share/haxe/std/haxe/crypto/Md5.hx",178,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_29_encode,"haxe.crypto.Md5","encode",0x979f4b6b,"haxe.crypto.Md5.encode","/usr/share/haxe/std/haxe/crypto/Md5.hx",29,0x179d5480)
HX_LOCAL_STACK_FRAME(_hx_pos_952f47cc2225e9ea_120_str2blks,"haxe.crypto.Md5","str2blks",0x2f788968,"haxe.crypto.Md5.str2blks","/usr/share/haxe/std/haxe/crypto/Md5.hx",120,0x179d5480)
namespace haxe{
namespace crypto{

void Md5_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_55_new)
            	}
...
int Md5_obj::bitOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_57_bitOR)
...
int Md5_obj::bitXOR(int a,int b){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_63_bitXOR)
...
int Md5_obj::bitAND(int a,int b){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_69_bitAND)
...
int Md5_obj::addme(int x,int y){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_75_addme)
...
::String Md5_obj::hex(::Array< int > a){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_81_hex)
...
int Md5_obj::rol(int num,int cnt){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_155_rol)
...
int Md5_obj::cmn(int q,int a,int b,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_159_cmn)
...
int Md5_obj::ff(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_163_ff)
...
int Md5_obj::gg(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_167_gg)
...
int Md5_obj::hh(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_171_hh)
...
int Md5_obj::ii(int a,int b,int c,int d,int x,int s,int t){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_175_ii)
...
::Array< int > Md5_obj::doEncode(::Array< int > x){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_178_doEncode)
...
::String Md5_obj::encode(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_952f47cc2225e9ea_29_encode)
...
::Array< int > Md5_obj::str2blks(::String str){
            	HX_STACKFRAME(&_hx_pos_952f47cc2225e9ea_120_str2blks)
